...
from src.routers.v1.endpoints import image_router, recommendation_router, keys_router
...
api_router.include_router(keys_router.keys_router, prefix="/keys", tags=["keys"])